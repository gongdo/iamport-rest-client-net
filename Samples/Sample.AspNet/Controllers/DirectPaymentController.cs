...
namespace Sample.AspNet.Controllers
{
    public class DirectPaymentController : Controller
    {
        ...
        public async Task<ActionResult> Index(RequestDirectPaymentModel input)
        {
            ...
            var checkout = AspNetCore.Models.Checkout.Create(
                name: input.Name,
                amount: input.Amount,
            ...
            var payment = AspNetCore.Models.Payment.Create(checkout.Id);
        ...
        public ActionResult Result(string transactionId)
        {
        ...
        private void RefreshPayment(Payment iamportPayment, AspNetCore.Models.Payment payment)
        {
